...
[![Build Status](https://scan.coverity.com/projects/6714/badge.svg)](https://scan.coverity.com/projects/cpp-netlib)
...
list](mailto:cpp-netlib@googlegroups.com).
...
* A build tool ([CMake](https://cmake.org/) is required)
* OpenSSL headers (optional)

> **Note:** This assumes that you have cpp-netlib at the top-level of your home directory.

## Hacking on cpp-netlib

cpp-netlib uses [git](http://git-scm.com/) for tracking work, and is hosted on [GitHub](http://github.com/).
cpp-netlib is hosted on [GitHub](http://github.com/) following the GitHub recommended practice of
forking the repository and submitting pull requests to the source repository.
You can read more about the [forking](http://help.github.com/forking/) process and submitting [pull requests](http://help.github.com/pull-requests/) if
...
Because cpp-netlib is released under the [Boost Software License](http://www.boost.org/LICENSE_1_0.txt) it is
...
contact the development team through the [developers mailing list](mailto:cpp-netlib@googlegroups.com)
