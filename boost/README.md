# Boost Namespace Headers

Top-level boost namespace directory containing the main library headers for cpp-netlib.
...
- **network.hpp**: Main network library header
- **mime.hpp**: MIME type handling header

## Subdirectories

- **network/**: Network library implementation headers
