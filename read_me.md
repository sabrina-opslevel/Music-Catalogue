...
[![image](https://travis-ci.org/cpp-netlib/cpp-netlib.svg?branch=master)](https://travis-ci.org/cpp-netlib/cpp-netlib)

[![image](https://scan.coverity.com/projects/6714/badge.svg)](https://scan.coverity.com/projects/cpp-netlib)
...
You can read more about the forking_ process and submitting [pull requests] if
...
Because cpp-netlib is released under the [Boost Software License] it is
...
contact the development team through the [developers mailing list]
